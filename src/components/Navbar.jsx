...
const Navbar = () => {
  return (
    <>
      <nav className="bg-[#F6D9A0] border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-[#F6D9A0]">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="#" className="flex items-center">
            <img
              ...
              alt="Image"
            />
            <span className="bg-white self-center text-xl font-semibold whitespace-nowrap dark:text-white dark:bg-[#FFF] homeIcon">
